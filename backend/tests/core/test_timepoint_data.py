...
from backend.app.routes.timepoint_data import process_timepoint
from backend.app.biclique_analysis import process_bicliques
from backend.app.biclique_analysis.components import process_components
