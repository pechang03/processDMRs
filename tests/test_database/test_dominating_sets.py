...
from database.models import DominatingSet, Timepoint
from database.operations import store_dominating_set, get_dominating_set
...
class TestDominatingSetStorage(unittest.TestCase):
    def setUp(self):
        ...
        self.timepoint = Timepoint(name="test_timepoint", description="Test timepoint")
