...
class TestGraphStatistics(unittest.TestCase):
    ...
    def test_biclique_classification(self):
        ...
        self.assertEqual(BicliqueSizeCategory.from_string("COMPLEX"), BicliqueSizeCategory.COMPLEX)
        ...
        gene_nodes = {self.gene_id_mapping[gene] for gene in ['genea', 'geneb', 'genec']}
        ...
        second_gene_nodes = {self.gene_id_mapping[gene] for gene in ['gened', 'genee', 'genef']}
    ...
    def test_component_analyzer(self):
        ...
        analyzer = ComponentAnalyzer(
            ...
            {"bicliques": [(set(range(3)), {self.gene_id_mapping[g] for g in ['genea', 'geneb', 'genec']})]},
