...
class TestTimepointData(unittest.TestCase):                                                               
    def setUp(self):                                                                                      
        ...
        edges = [                                                                                         
            # Biclique 1 edges                                                                            
            (0, START_GENE_ID), (0, START_GENE_ID+1), (0, START_GENE_ID+2),                               
            (1, START_GENE_ID), (1, START_GENE_ID+1), (1, START_GENE_ID+2),                               
            (2, START_GENE_ID), (2, START_GENE_ID+1), (2, START_GENE_ID+2),                               
                                                                                                        
            # Biclique 2 edges                                                                            
            (2, START_GENE_ID+1), (2, START_GENE_ID+2), (2, START_GENE_ID+3),                             
            (3, START_GENE_ID+1), (3, START_GENE_ID+2), (3, START_GENE_ID+3),                             
            (4, START_GENE_ID+1), (4, START_GENE_ID+2), (4, START_GENE_ID+3),                             
                                                                                                        
            # Biclique 3 edges                                                                            
            (4, START_GENE_ID+2), (4, START_GENE_ID+3), (4, START_GENE_ID+4),                             
            (5, START_GENE_ID+2), (5, START_GENE_ID+3), (5, START_GENE_ID+4)                              
        ]                                                                                                 
        ...
        self.mock_bicliques_result = {                                                                    
            "bicliques": [                                                                                
                ({0, 1, 2}, {START_GENE_ID, START_GENE_ID+1, START_GENE_ID+2}),    # Biclique 1           
                ({2, 3, 4}, {START_GENE_ID+1, START_GENE_ID+2, START_GENE_ID+3}),  # Biclique 2           
                ({4, 5}, {START_GENE_ID+2, START_GENE_ID+3, START_GENE_ID+4}),     # Biclique 3           
            ],                                                                                            
            "stats": {                                                                                    
                "coverage": {                                                                             
                ...
                "components": {                                                                           
                    "original": {                                                                         
                        "connected": {"total": 1, "single_node": 0, "small": 0, "interesting": 1},        
                        "biconnected": {"total": 1, "single_node": 0, "small": 0, "interesting": 1},      
                        "triconnected": {"total": 1, "single_node": 0, "small": 0, "interesting": 1},     
                    },                                                                                    
                    "biclique": {                                                                         
                        "connected": {"total": 1, "single_node": 0, "small": 0, "interesting": 1}         
                    },                                                                                    
    ...
    def test_timepoint_data_structure(self):                                                              
        ...
        with patch('routes.timepoint_data.process_data') as mock_process:                                 
            mock_process.return_value = {                                                                 
                "DSS1": {                                                                                 
                    ...
                    "complex_components": [{                                                              
                        ...
                        "category": "complex",                                                            
                        "raw_bicliques": [                                                                
                            ({0, 1, 2}, {START_GENE_ID, START_GENE_ID+1, START_GENE_ID+2}),               
                            ({2, 3, 4}, {START_GENE_ID+1, START_GENE_ID+2, START_GENE_ID+3}),             
                            ({4, 5}, {START_GENE_ID+2, START_GENE_ID+3, START_GENE_ID+4}),                
                        ],                                                                                
                        "split_genes": [START_GENE_ID+1, START_GENE_ID+2, START_GENE_ID+3],               
                        "edge_classifications": {                                                         
                            "permanent": [(0, START_GENE_ID), (1, START_GENE_ID)],                        
                            "shared": [(2, START_GENE_ID+2), (4, START_GENE_ID+2)],                       
                            "bridge": [(2, START_GENE_ID+1), (4, START_GENE_ID+3)]                        
                        }                                                                                 
                    }],                                                                                   
            ...
            self.assertTrue(all(key in edge_class for key in ["permanent", "shared", "bridge"]))          
