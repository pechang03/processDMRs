import unittest
from visualization.graph_layout_logical import (
...
class TestEmptyBicliquesLayout(unittest.TestCase):
    ...
    def test_empty_bicliques(self):
        ...
        positions = calculate_node_positions(self.empty_bicliques, self.node_biclique_map)
    ...
    def test_node_info_empty_bicliques(self):
        ...
        node_info = collect_node_information(self.empty_bicliques, self.node_biclique_map)
